    ...
    <div className={classes.videos}>
      <div className={classes.btns}>
        ...
        <button
          onClick={handleCategory}
          value="music"
          className={category === "music" ? classes.active : ""}
        >
          Music
        </button>
        <button
          onClick={handleCategory}
          value="gaming"
          className={category === "gaming" ? classes.active : ""}
        >
          Gaming
        </button>
        <button
          onClick={handleCategory}
          value="movie"
          className={category === "movie" ? classes.active : ""}
        >
          Movie
        </button>
        <button
          onClick={handleCategory}
          value="trailer"
          className={category === "trailer" ? classes.active : ""}
        >
          Trailer
        </button>
      </div>
      <div className={classes["videos-grid"]}>
        {status === "pending" && filterVideos.length === 0 && (
          <VideoGridShimmer />
        )}
        ...
        {filterVideos.length === 0 && status === "success" && (
          <p>No videos found!</p>
        )}
      </div>
    </div>
